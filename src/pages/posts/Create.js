...
const CreatePost = () => {
        ...
        fetch('https://jsonplaceholder.typicode.com/posts', {
            ...
            .then((data) => {
                ...
                Swal.fire({
                    ...
                    text: "Ihre Fahrradmontage war erfolgreich abgeschlossen. Ihr perfekt montiertes Fahrrad steht nun für aufregende Abenteuer bereit.",
                    icon: "success",
    ...
    return (
        <div className="container bg-light">
                ...
                <h2 className="mt-5">Neue Konfiguration :</h2>
               <span className="mt-3">Durch Klicken auf die Schaltfläche 'Erstellen' können Sie das Fahrrad basierend auf den Kundenwünschen konfigurieren.</span>
            ...
            <div className="card-body">
              ...
              <hr className="fs-5"/>
                ...
                <button type="submit" className="btn btn-dark  "  disabled={title === '' || body=== ''} >{loading && <div className="spinner-border" />}Erstellen</button>
                 ...
                 <p className="fs-sm text-primary">Das Formular wird erst dann an den Server ( JSONPlaceholder :Free fake API for testing and prototyping.) gesendet, wenn alle ausgefüllt sind.</p>
            </div>
          </div>
